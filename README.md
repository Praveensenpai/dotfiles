...
└── scripts/
    ...
    ├── setup_fastfetch_welcome.sh      # Enables fastfetch system info banner on terminal launch 💻
...
| `setup_fastfetch_welcome.sh` | Installs `fastfetch` and appends welcome banner hook to `~/.bashrc` / `~/.zshrc`. |
